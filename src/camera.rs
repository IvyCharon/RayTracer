...
impl Camera{
    pub fn new() -> Self{
        ...
        Self{
            ...
            lower_left_corner: Vec3::new(0.0,0.0,0.0) - Vec3::new(viewport_width.clone(), 0.0, 0.0) / 2.0 - Vec3::new(0.0,viewport_height.clone(),0.0) / 2.0 - Vec3::new(0.0,0.0,focal_length.clone()),
